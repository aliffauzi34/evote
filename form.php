...
<h2 class="index-header">Selamat Datang di E-Voting Pemilihan Ketua OSIS<br />SMKN 1 Bendo</h2>
<div class="row">
    ...
    <div class="col-md-6 form">
        ...
        <form action="" method="post">
            <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="NIS" required="NIS" name="nis"/>
            </div>
            <br />
            <div class="row">
